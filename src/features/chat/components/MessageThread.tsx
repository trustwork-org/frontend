             ...
             <div key={message.id}>
               {showDayDivider && (
                 <div className="my-4 flex justify-center">
                   <span className="rounded-full bg-white border border-[#e0e0dc] px-3 py-1 
               ...
               <div className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                 <div
                   className={`max-w-[85%] rounded-2xl px-3 py-2 ${
                     isMe ? 'bg-[#14a800] text-white' : 'bg-white border border-[#e0e0dc] 
text-[#1c1c1c]'
                   }`}
                 >
                   ...
                   <div className={`mt-1 text-[11px] ${isMe ? 'text-[#e6f4e1]' : 
'text-[#a0a0a0]'}`}>
